...
class RSC(
    AdminAGMMixIn[RSCProtocol],
    AdminAuditMixIn[RSCProtocol],
    AdminFranchiseMixIn[RSCProtocol],
    AdminInactivityMixIn[RSCProtocol],
    AdminIntentsMixIn[RSCProtocol],
    AdminMatchMixIn[RSCProtocol],
    AdminMembersMixIn[RSCProtocol],
    # AdminPermFAMixIn,
    AdminStatsMixIn[RSCProtocol],
    AdminSyncMixIn[RSCProtocol],
    BallchasingMixIn[RSCProtocol],
    CombineMixIn[RSCProtocol],
    DeveloperMixIn[RSCProtocol],
    DevLeagueMixIn[RSCProtocol],
    ExtrasMixIn[RSCProtocol],
    FranchiseMixIn[RSCProtocol],
    FreeAgentMixIn[RSCProtocol],
    LeagueMixIn[RSCProtocol],
    LLMMixIn[RSCProtocol],
    MatchMixIn[RSCProtocol],
    MemberMixIn[RSCProtocol],
    ModeratorMixIn[RSCProtocol],
    NumberMixIn[RSCProtocol],
    SeasonsMixIn[RSCProtocol],
    StatsMixIn[RSCProtocol],
    TeamMixIn[RSCProtocol],
    ThreadMixIn[RSCProtocol],
    TierMixIn[RSCProtocol],
    TrackerMixIn[RSCProtocol],
    TransactionMixIn[RSCProtocol],
    TrophyMixIn[RSCProtocol],
    UtilsMixIn[RSCProtocol],
    WelcomeMixIn[RSCProtocol],
    commands.Cog,
